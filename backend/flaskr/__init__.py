...
def create_app(test_config=None):
  ...
  def search_questions():
    ...
    search_question=Question.query.filter(Question.question.ilike('%{}%'.format(data['searchTerm']))).all()
    questions_f = [question.format() for question in search_question]
    ...
    return jsonify ({
        'questions' : questions_f[start:end] ,
        'total_questions' : len(questions_f) ,
        'success' : True 
      })
